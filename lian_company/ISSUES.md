...
| 시스템 | 경로 | 상태 |
|--------|------|------|
| 네이버 플레이스 크롤러 | `core/naver_crawler.py` | ✅ |
| 개인화 DM 생성기 | `core/personalized_dm.py` | ✅ |
| KPI 시스템 | `core/kpi.py` | ✅ |
| 에이전트 자기 개선 루프 | `core/agent_improver.py` | ✅ |
| 카페전문마케팅팀 | `teams/카페전문마케팅팀/` | ✅ |
| 뷰티샵전문납품팀 | `teams/뷰티샵전문납품팀/` | 🔄 생성중 |
